...
进入 [[上下文工程/02-选择、相关性与来源|选择、相关性与来源]]，决定有限预算该给谁。

## 参考资料

- [OpenAI：Conversation state—Managing context for text generation](https://developers.openai.com/api/docs/guides/conversation-state#managing-context-for-text-generation)（访问于 2026-07-14）
