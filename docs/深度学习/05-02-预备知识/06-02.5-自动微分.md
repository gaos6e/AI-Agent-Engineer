---
title: "2.5. 自动微分"
source: "https://zh-v2.d2l.ai/chapter_preliminaries/autograd.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[2.5. 自动微分](https://zh-v2.d2l.ai/chapter_preliminaries/autograd.html)
> 项目：[动手学深度学习](https://github.com/d2l-ai/d2l-zh)
> 许可：[Apache-2.0](https://github.com/d2l-ai/d2l-zh/blob/master/LICENSE)

正如 [2.4节](https://zh-v2.d2l.ai/chapter_preliminaries/calculus.html#sec-calculus) 中所说，求导是几乎所有深度学习优化算法的关键步骤。 虽然求导的计算很简单，只需要一些基本的微积分。 但对于复杂的模型，手工进行更新是一件很痛苦的事情（而且经常容易出错）。
