---
title: "2.6. 概率"
source: "https://zh-v2.d2l.ai/chapter_preliminaries/probability.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[2.6. 概率](https://zh-v2.d2l.ai/chapter_preliminaries/probability.html)
...
[![../_images/cat-dog-pixels.png](https://zh-v2.d2l.ai/_images/cat-dog-pixels.png)](https://zh-v2.d2l.ai/_images/cat-dog-pixels.png)

图2.6.1 不同分辨率的图像 ($10 \times 10$, $20 \times 20$, $40 \times 40$, $80 \times 80$, 和 $160 \times 160$ pixels) [¶](#id15 "Permalink to this image")

如 所示，虽然人类很容易以 $160 \times 160$ 像素的分辨率识别猫和狗， 但它在 $40\times40$ 像素上变得具有挑战性，而且在 $10 \times 10$ 像素下几乎是不可能的。 换句话说，我们在很远的距离（从而降低分辨率）区分猫和狗的能力可能会变为猜测。 概率给了我们一种正式的途径来说明我们的确定性水平。 如果我们完全肯定图像是一只猫，我们说标签 $y$ 是“猫”的 *概率* ，表示为 $P(y=$ “猫”$)$ 等于 $1$ 。 如果我们没有证据表明 $y=$ “猫”或 $y=$ “狗”，那么我们可以说这两种可能性是相等的， 即 $P(y=$ “猫”$)=P(y=$ “狗”$)=0.5$ 。 如果我们不十分确定图像描绘的是一只猫，我们可以将概率赋值为 $0.5<P(y=$ “猫”$)<1$ 。
...
![../_images/output_probability_245b7d_63_0.svg](https://zh-v2.d2l.ai/_images/output_probability_245b7d_63_0.svg)
...
![../_images/output_probability_245b7d_69_0.svg](https://zh-v2.d2l.ai/_images/output_probability_245b7d_69_0.svg)
...
![../_images/output_probability_245b7d_72_1.svg](https://zh-v2.d2l.ai/_images/output_probability_245b7d_72_1.svg)
...
(2.6.2) [¶](#equation-chapter-preliminaries-probability-1 "Permalink to this equation") $P(B) = \sum_{A} P(A, B),$
...
我们实战演练一下！ 假设一个医生对患者进行艾滋病病毒（HIV）测试。 这个测试是相当准确的，如果患者健康但测试显示他患病，这个概率只有1%； 如果患者真正感染HIV，它永远不会检测不出。 我们使用 $D_1$ 来表示诊断结果（如果阳性，则为 $1$ ，如果阴性，则为 $0$ ）， $H$ 来表示感染艾滋病病毒的状态（如果阳性，则为 $1$ ，如果阴性，则为 $0$ ）。 在 中列出了这样的条件概率。
...
(2.6.3) [¶](#equation-chapter-preliminaries-probability-2 "Permalink to this equation") $\begin{split}\begin{aligned}
&P(D_1 = 1) \\
...
(2.6.4) [¶](#equation-chapter-preliminaries-probability-3 "Permalink to this equation") $\begin{split}\begin{aligned}
...
患者在收到这样可怕的消息后应该怎么办？ 很可能，患者会要求医生进行另一次测试来确定病情。 第二个测试具有不同的特性，它不如第一个测试那么精确， 如 所示。
...
(2.6.5) [¶](#equation-chapter-preliminaries-probability-4 "Permalink to this equation") $\begin{split}\begin{aligned}
&P(D_1 = 1, D_2 = 1 \mid H = 0) \\
=& P(D_1 = 1 \mid H = 0) P(D_2 = 1 \mid H = 0)  \\
=& 0.0003,
\end{aligned}\end{split}$

(2.6.6) [¶](#equation-chapter-preliminaries-probability-5 "Permalink to this equation") $\begin{split}\begin{aligned}
...
(2.6.7) [¶](#equation-chapter-preliminaries-probability-6 "Permalink to this equation") $\begin{split}\begin{aligned}
&P(D_1 = 1, D_2 = 1) \\
...
(2.6.8) [¶](#equation-chapter-preliminaries-probability-7 "Permalink to this equation") $\begin{split}\begin{aligned}
...
(2.6.9) [¶](#equation-chapter-preliminaries-probability-8 "Permalink to this equation") $E[X] = \sum_{x} x P(X = x).$

当函数 $f(x)$ 的输入是从分布 $P$ 中抽取的随机变量时， $f(x)$ 的期望值为

(2.6.10) [¶](#equation-chapter-preliminaries-probability-9 "Permalink to this equation") $E_{x \sim P}[f(x)] = \sum_x f(x) P(x).$

在许多情况下，我们希望衡量随机变量 $X$ 与其期望值的偏置。这可以通过方差来量化

(2.6.11) [¶](#equation-chapter-preliminaries-probability-10 "Permalink to this equation") $\mathrm{Var}[X] = E\left[(X - E[X])^2\right] =
E[X^2] - E[X]^2.$
...
4. 在 中，第一个测试更准确。为什么不运行第一个测试两次，而是同时运行第一个和第二个测试?
