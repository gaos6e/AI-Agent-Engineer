---
title: "15.2. 情感分析：使用循环神经网络"
source: "https://zh-v2.d2l.ai/chapter_natural-language-processing-applications/sentiment-analysis-rnn.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[15.2. 情感分析：使用循环神经网络](https://zh-v2.d2l.ai/chapter_natural-language-processing-applications/sentiment-analysis-rnn.html)
> 项目：[动手学深度学习](https://github.com/d2l-ai/d2l-zh)
> 许可：[Apache-2.0](https://github.com/d2l-ai/d2l-zh/blob/master/LICENSE)

与词相似度和类比任务一样，我们也可以将预先训练的词向量应用于情感分析。由于 [15.1节](https://zh-v2.d2l.ai/chapter_natural-language-processing-applications/sentiment-analysis-and-dataset.html#sec-sentiment) 中的IMDb评论数据集不是很大，使用在大规模语料库上预训练的文本表示可以减少模型的过拟合。作为 中所示的具体示例，我们将使用预训练的GloVe模型来表示每个词元，并将这些词元表示送入多层双向循环神经网络以获得文本序列表示，该文本序列表示将被转换为情感分析输出 ([Maas *et al.*, 2011](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id104 "Maas, A. L., Daly, R. E., Pham, P. T., Huang, D., Ng, A. Y., & Potts, C. (2011). Learning word vectors for sentiment analysis. Proceedings of the 49th annual meeting of the association for computational linguistics: Human language technologies-volume 1 (pp. 142–150)."))。对于相同的下游应用，我们稍后将考虑不同的架构选择。

![../_images/nlp-map-sa-rnn.svg](https://zh-v2.d2l.ai/_images/nlp-map-sa-rnn.svg)
...
![../_images/output_sentiment-analysis-rnn_6199ad_76_1.svg](https://zh-v2.d2l.ai/_images/output_sentiment-analysis-rnn_6199ad_76_1.svg)
...
![../_images/output_sentiment-analysis-rnn_6199ad_79_1.svg](https://zh-v2.d2l.ai/_images/output_sentiment-analysis-rnn_6199ad_79_1.svg)
...
![../_images/output_sentiment-analysis-rnn_6199ad_82_1.svg](https://zh-v2.d2l.ai/_images/output_sentiment-analysis-rnn_6199ad_82_1.svg)
...
[Previous](https://zh-v2.d2l.ai/chapter_natural-language-processing-applications/sentiment-analysis-and-dataset.html)

[15.1. 情感分析及数据集](https://zh-v2.d2l.ai/chapter_natural-language-processing-applications/sentiment-analysis-and-dataset.html)[Next
