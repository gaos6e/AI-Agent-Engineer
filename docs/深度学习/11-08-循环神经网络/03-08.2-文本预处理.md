---
title: "8.2. 文本预处理"
source: "https://zh-v2.d2l.ai/chapter_recurrent-neural-networks/text-preprocessing.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[8.2. 文本预处理](https://zh-v2.d2l.ai/chapter_recurrent-neural-networks/text-preprocessing.html)
> 项目：[动手学深度学习](https://github.com/d2l-ai/d2l-zh)
> 许可：[Apache-2.0](https://github.com/d2l-ai/d2l-zh/blob/master/LICENSE)

对于序列数据处理问题，我们在 [8.1节](https://zh-v2.d2l.ai/chapter_recurrent-neural-networks/sequence.html#sec-sequence) 中 评估了所需的统计工具和预测时面临的挑战。 这样的数据存在许多种形式，文本是最常见例子之一。 例如，一篇文章可以被简单地看作一串单词序列，甚至是一串字符序列。 本节中，我们将解析文本的常见预处理步骤。 这些步骤通常包括：
