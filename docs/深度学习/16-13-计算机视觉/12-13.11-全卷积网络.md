---
title: "13.11. 全卷积网络"
source: "https://zh-v2.d2l.ai/chapter_computer-vision/fcn.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[13.11. 全卷积网络](https://zh-v2.d2l.ai/chapter_computer-vision/fcn.html)
> 项目：[动手学深度学习](https://github.com/d2l-ai/d2l-zh)
> 许可：[Apache-2.0](https://github.com/d2l-ai/d2l-zh/blob/master/LICENSE)

如 [13.9节](https://zh-v2.d2l.ai/chapter_computer-vision/semantic-segmentation-and-dataset.html#sec-semantic-segmentation) 中所介绍的那样，语义分割是对图像中的每个像素分类。 *全卷积网络* （fully convolutional network，FCN）采用卷积神经网络实现了从图像像素到像素类别的变换 ([Long *et al.*, 2015](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id100 "Long, J., Shelhamer, E., & Darrell, T. (2015). Fully convolutional networks for semantic segmentation. Proceedings of the IEEE conference on computer vision and pattern recognition (pp. 3431–3440)."))。 与我们之前在图像分类或目标检测部分介绍的卷积神经网络不同，全卷积网络将中间层特征图的高和宽变换回输入图像的尺寸：这是通过在 [13.10节](https://zh-v2.d2l.ai/chapter_computer-vision/transposed-conv.html#sec-transposed-conv) 中引入的 *转置卷积* （transposed convolution）实现的。 因此，输出的类别预测与输入图像在像素级别上具有一一对应关系：通道维的输出即该位置对应像素的类别预测。
...
下面我们了解一下全卷积网络模型最基本的设计。 如 所示，全卷积网络先使用卷积神经网络抽取图像特征，然后通过 $1\times 1$ 卷积层将通道数变换为类别个数，最后在 [13.10节](https://zh-v2.d2l.ai/chapter_computer-vision/transposed-conv.html#sec-transposed-conv) 中通过转置卷积层将特征图的高和宽变换为输入图像的尺寸。 因此，模型输出与输入图像的高和宽相同，且最终输出通道包含了该空间位置像素的类别预测。
...
接下来使用 $1\times1$ 卷积层将输出通道数转换为Pascal VOC2012数据集的类数（21类）。 最后需要将特征图的高度和宽度增加32倍，从而将其变回输入图像的高和宽。 回想一下 [6.3节](https://zh-v2.d2l.ai/chapter_convolutional-neural-networks/padding-and-strides.html#sec-padding) 中卷积层输出形状的计算方法： 由于 $(320-64+16\times2+32)/32=10$ 且 $(480-64+16\times2+32)/32=15$ ，我们构造一个步幅为 $32$ 的转置卷积层，并将卷积核的高和宽设为 $64$ ，填充为 $16$ 。 我们可以看到如果步幅为 $s$ ，填充为 $s/2$ （假设 $s/2$ 是整数）且卷积核的高和宽为 $2s$ ，转置卷积核会将输入的高和宽分别放大 $s$ 倍。
...
可以看到，转置卷积层将图像的高和宽分别放大了2倍。 除了坐标刻度不同，双线性插值放大的图像和在 [13.3节](https://zh-v2.d2l.ai/chapter_computer-vision/bounding-box.html#sec-bbox) 中打印出的原图看上去没什么两样。
...
![../_images/output_fcn_ce3435_99_1.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_99_1.svg)
...
![../_images/output_fcn_ce3435_102_1.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_102_1.svg)
...
![../_images/output_fcn_ce3435_105_1.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_105_1.svg)
...
我们用 [13.9节](https://zh-v2.d2l.ai/chapter_computer-vision/semantic-segmentation-and-dataset.html#sec-semantic-segmentation) 中介绍的语义分割读取数据集。 指定随机裁剪的输出图像的形状为 $320\times 480$ ：高和宽都可以被 $32$ 整除。
...
![../_images/output_fcn_ce3435_135_1.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_135_1.svg)
...
![../_images/output_fcn_ce3435_138_1.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_138_1.svg)
...
![../_images/output_fcn_ce3435_141_1.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_141_1.svg)
...
![../_images/output_fcn_ce3435_171_0.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_171_0.svg)
...
![../_images/output_fcn_ce3435_174_0.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_174_0.svg)
...
![../_images/output_fcn_ce3435_177_0.svg](https://zh-v2.d2l.ai/_images/output_fcn_ce3435_177_0.svg)
...
3. 预测测试图像中所有像素的类别。
4. 最初的全卷积网络的论文中 ([Long *et al.*, 2015](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id100 "Long, J., Shelhamer, E., & Darrell, T. (2015). Fully convolutional networks for semantic segmentation. Proceedings of the IEEE conference on computer vision and pattern recognition (pp. 3431–3440)."))还使用了某些卷积神经网络中间层的输出。试着实现这个想法。
