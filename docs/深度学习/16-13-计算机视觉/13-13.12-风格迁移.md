---
title: "13.12. 风格迁移"
source: "https://zh-v2.d2l.ai/chapter_computer-vision/neural-style.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[13.12. 风格迁移](https://zh-v2.d2l.ai/chapter_computer-vision/neural-style.html)
...
本节将介绍如何使用卷积神经网络，自动将一个图像中的风格应用在另一图像之上，即 *风格迁移* （style transfer） ([Gatys *et al.*, 2016](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id40 "Gatys, L. A., Ecker, A. S., & Bethge, M. (2016). Image style transfer using convolutional neural networks. Proceedings of the IEEE conference on computer vision and pattern recognition (pp. 2414–2423)."))。 这里我们需要两张输入图像：一张是 *内容图像* ，另一张是 *风格图像* 。 我们将使用神经网络修改内容图像，使其在风格上接近风格图像。 例如， 中的内容图像为本书作者在西雅图郊区的雷尼尔山国家公园拍摄的风景照，而风格图像则是一幅主题为秋天橡树的油画。 最终输出的合成图像应用了风格图像的油画笔触让整体颜色更加鲜艳，同时保留了内容图像中物体主体的形状。
...
用简单的例子阐述了基于卷积神经网络的风格迁移方法。 首先，我们初始化合成图像，例如将其初始化为内容图像。 该合成图像是风格迁移过程中唯一需要更新的变量，即风格迁移所需迭代的模型参数。 然后，我们选择一个预训练的卷积神经网络来抽取图像的特征，其中的模型参数在训练中无须更新。 这个深度卷积神经网络凭借多个层逐级抽取图像的特征，我们可以选择其中某些层的输出作为内容特征或风格特征。 以 为例，这里选取的预训练的神经网络含有3个卷积层，其中第二层输出内容特征，第一层和第三层输出风格特征。
...
![../_images/output_neural-style_5de8ca_3_1.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_3_1.svg)
...
![../_images/output_neural-style_5de8ca_4_0.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_4_0.svg)
...
![../_images/output_neural-style_5de8ca_7_0.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_7_0.svg)
...
![../_images/output_neural-style_5de8ca_8_0.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_8_0.svg)
...
![../_images/output_neural-style_5de8ca_11_0.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_11_0.svg)
...
![../_images/output_neural-style_5de8ca_12_0.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_12_0.svg)
...
我们使用基于ImageNet数据集预训练的VGG-19模型来抽取图像特征 ([Gatys *et al.*, 2016](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id40 "Gatys, L. A., Ecker, A. S., & Bethge, M. (2016). Image style transfer using convolutional neural networks. Proceedings of the IEEE conference on computer vision and pattern recognition (pp. 2414–2423)."))。
...
(13.12.1) [¶](#equation-chapter-computer-vision-neural-style-0 "Permalink to this equation") $\sum_{i, j} \left|x_{i, j} - x_{i+1, j}\right| + \left|x_{i, j} - x_{i, j+1}\right|$
...
![../_images/output_neural-style_5de8ca_186_0.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_186_0.svg)
...
![../_images/output_neural-style_5de8ca_189_0.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_189_0.svg)
...
![../_images/output_neural-style_5de8ca_192_0.svg](https://zh-v2.d2l.ai/_images/output_neural-style_5de8ca_192_0.svg)
...
4. 我们可以对文本使用风格迁移吗？提示:可以参阅调查报告 ([Hu *et al.*, 2020](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id71 "Hu, Z., Lee, R. K.-W., Aggarwal, C. C., & Zhang, A. (2020). Text style transfer: a review and experimental evaluation. arXiv preprint arXiv:2010.12742."))。
