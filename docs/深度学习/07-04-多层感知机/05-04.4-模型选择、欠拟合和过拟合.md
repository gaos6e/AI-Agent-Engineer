...
source: "https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/underfit-overfit.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[4.4. 模型选择、欠拟合和过拟合](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/underfit-overfit.html)
...
(4.4.1) [¶](#equation-chapter-multilayer-perceptrons-underfit-overfit-0 "Permalink to this equation") $\hat{y}= \sum_{i=0}^d x^i w_i$

这只是一个线性回归问题，我们的特征是 $x$ 的幂给出的， 模型的权重是 $w_i$ 给出的，偏置是 $w_0$ 给出的 （因为对于所有的 $x$ 都有 $x^0 = 1$ ）。 由于这只是一个线性回归问题，我们可以使用平方误差作为我们的损失函数。

高阶多项式函数比低阶多项式函数复杂得多。 高阶多项式的参数较多，模型函数的选择范围较广。 因此在固定训练数据集的情况下， 高阶多项式函数相对于低阶多项式的训练误差应该始终更低（最坏也是相等）。 事实上，当数据样本包含了 $x$ 的不同值时， 函数阶数等于数据样本数量的多项式函数可以完美拟合训练集。 在 中， 我们直观地描述了多项式的阶数和欠拟合与过拟合之间的关系。
...
(4.4.2) [¶](#equation-chapter-multilayer-perceptrons-underfit-overfit-1 "Permalink to this equation") $y = 5 + 1.2x - 3.4\frac{x^2}{2!} + 5.6 \frac{x^3}{3!} + \epsilon \text{ where }
...
![../_images/output_underfit-overfit_ec26bd_78_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_78_1.svg)
...
![../_images/output_underfit-overfit_ec26bd_84_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_84_1.svg)
...
![../_images/output_underfit-overfit_ec26bd_87_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_87_1.svg)
...
![../_images/output_underfit-overfit_ec26bd_93_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_93_1.svg)
...
![../_images/output_underfit-overfit_ec26bd_99_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_99_1.svg)
...
![../_images/output_underfit-overfit_ec26bd_102_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_102_1.svg)
...
![../_images/output_underfit-overfit_ec26bd_108_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_108_1.svg)
...
![../_images/output_underfit-overfit_ec26bd_114_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_114_1.svg)
...
![../_images/output_underfit-overfit_ec26bd_117_1.svg](https://zh-v2.d2l.ai/_images/output_underfit-overfit_ec26bd_117_1.svg)
