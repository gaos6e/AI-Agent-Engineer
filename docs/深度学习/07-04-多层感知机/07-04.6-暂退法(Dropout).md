---
title: "4.6. 暂退法（Dropout）"
source: "https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/dropout.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[4.6. 暂退法（Dropout）](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/dropout.html)
> 项目：[动手学深度学习](https://github.com/d2l-ai/d2l-zh)
> 许可：[Apache-2.0](https://github.com/d2l-ai/d2l-zh/blob/master/LICENSE)

在 [4.5节](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/weight-decay.html#sec-weight-decay) 中， 我们介绍了通过惩罚权重的 $L_2$ 范数来正则化统计模型的经典方法。 在概率角度看，我们可以通过以下论证来证明这一技术的合理性： 我们已经假设了一个先验，即权重的值取自均值为0的高斯分布。 更直观的是，我们希望模型深度挖掘特征，即将其权重分散到许多特征中， 而不是过于依赖少数潜在的虚假关联。
...
(4.6.1) [¶](#equation-chapter-multilayer-perceptrons-dropout-0 "Permalink to this equation") $\begin{split}\begin{aligned}
h' =
\begin{cases}
    0 & \text{ 概率为 } p \\
    \frac{h}{1-p} & \text{ 其他情况}
...
回想一下 [图4.1.1](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/mlp.html#fig-mlp) 中带有1个隐藏层和5个隐藏单元的多层感知机。 当我们将暂退法应用到隐藏层，以 $p$ 的概率将隐藏单元置为零时， 结果可以看作一个只包含原始神经元子集的网络。 比如在 中，删除了 $h_2$ 和 $h_5$ ， 因此输出的计算不再依赖于 $h_2$ 或 $h_5$ ，并且它们各自的梯度在执行反向传播时也会消失。 这样，输出层的计算不能过度依赖于 $h_1, \ldots, h_5$ 的任何一个元素。
...
![../_images/output_dropout_1110bf_63_0.svg](https://zh-v2.d2l.ai/_images/output_dropout_1110bf_63_0.svg)
...
![../_images/output_dropout_1110bf_66_0.svg](https://zh-v2.d2l.ai/_images/output_dropout_1110bf_66_0.svg)
...
![../_images/output_dropout_1110bf_69_0.svg](https://zh-v2.d2l.ai/_images/output_dropout_1110bf_69_0.svg)
...
![../_images/output_dropout_1110bf_72_0.svg](https://zh-v2.d2l.ai/_images/output_dropout_1110bf_72_0.svg)
...
![../_images/output_dropout_1110bf_93_0.svg](https://zh-v2.d2l.ai/_images/output_dropout_1110bf_93_0.svg)
...
![../_images/output_dropout_1110bf_96_0.svg](https://zh-v2.d2l.ai/_images/output_dropout_1110bf_96_0.svg)
...
![../_images/output_dropout_1110bf_99_0.svg](https://zh-v2.d2l.ai/_images/output_dropout_1110bf_99_0.svg)
...
![../_images/output_dropout_1110bf_102_0.svg](https://zh-v2.d2l.ai/_images/output_dropout_1110bf_102_0.svg)
...
[Previous](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/weight-decay.html)

[4.5. 权重衰减](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/weight-decay.html)[Next
