---
title: "4.5. 权重衰减"
source: "https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/weight-decay.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[4.5. 权重衰减](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/weight-decay.html)
...
回想一下，在多项式回归的例子（ [4.4节](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/underfit-overfit.html#sec-model-selection) ）中， 我们可以通过调整拟合多项式的阶数来限制模型的容量。 实际上，限制特征的数量是缓解过拟合的一种常用技术。 然而，简单地丢弃特征对这项工作来说可能过于生硬。 我们继续思考多项式回归的例子，考虑高维输入可能发生的情况。 多项式对多变量数据的自然扩展称为 *单项式* （monomials）， 也可以说是变量幂的乘积。 单项式的阶数是幂的和。 例如， $x_1^2 x_2$ 和 $x_3 x_5^2$ 都是3次单项式。
...
在 [2.3.10节](https://zh-v2.d2l.ai/chapter_preliminaries/linear-algebra.html#subsec-lin-algebra-norms) 中， 我们已经描述了 $L_2$ 范数和 $L_1$ 范数， 它们是更为一般的 $L_p$ 范数的特殊情况。
...
(4.5.1) [¶](#equation-chapter-multilayer-perceptrons-weight-decay-0 "Permalink to this equation") $L(\mathbf{w}, b) = \frac{1}{n}\sum_{i=1}^n \frac{1}{2}\left(\mathbf{w}^\top \mathbf{x}^{(i)} + b - y^{(i)}\right)^2.$
...
使用与 [(3.1.10)](https://zh-v2.d2l.ai/chapter_linear-networks/linear-regression.html#equation-eq-linreg-batch-update) 中的相同符号， $L_2$ 正则化回归的小批量随机梯度下降更新如下式：

(4.5.3) [¶](#equation-chapter-multilayer-perceptrons-weight-decay-2 "Permalink to this equation") $\begin{aligned}
...
(4.5.4) [¶](#equation-chapter-multilayer-perceptrons-weight-decay-3 "Permalink to this equation") $y = 0.05 + \sum_{i = 1}^d 0.01 x_i + \epsilon \text{ where }
...
下面的代码将模型拟合训练数据集，并在测试数据集上进行评估。 从 [3节](https://zh-v2.d2l.ai/chapter_linear-networks/index.html#chap-linear) 以来，线性网络和平方损失没有变化， 所以我们通过 `d2l.linreg` 和 `d2l.squared_loss` 导入它们。 唯一的变化是损失现在包括了惩罚项。
...
![../_images/output_weight-decay_ec9cc0_78_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_78_1.svg)
...
![../_images/output_weight-decay_ec9cc0_84_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_84_1.svg)
...
![../_images/output_weight-decay_ec9cc0_87_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_87_1.svg)
...
![../_images/output_weight-decay_ec9cc0_93_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_93_1.svg)
...
![../_images/output_weight-decay_ec9cc0_96_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_96_1.svg)
...
![../_images/output_weight-decay_ec9cc0_99_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_99_1.svg)
...
![../_images/output_weight-decay_ec9cc0_102_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_102_1.svg)
...
![../_images/output_weight-decay_ec9cc0_126_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_126_1.svg)
...
![../_images/output_weight-decay_ec9cc0_127_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_127_1.svg)
...
![../_images/output_weight-decay_ec9cc0_134_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_134_1.svg)
...
![../_images/output_weight-decay_ec9cc0_135_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_135_1.svg)
...
![../_images/output_weight-decay_ec9cc0_138_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_138_1.svg)
...
![../_images/output_weight-decay_ec9cc0_139_1.svg](https://zh-v2.d2l.ai/_images/output_weight-decay_ec9cc0_139_1.svg)
...
4. 我们知道 $\|\mathbf{w}\|^2 = \mathbf{w}^\top \mathbf{w}$ 。能找到类似的矩阵方程吗（见 [2.3.10节](https://zh-v2.d2l.ai/chapter_preliminaries/linear-algebra.html#subsec-lin-algebra-norms) 中的Frobenius范数）？
