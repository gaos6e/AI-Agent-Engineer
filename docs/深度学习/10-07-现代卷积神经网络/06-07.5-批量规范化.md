---
title: "7.5. 批量规范化"
source: "https://zh-v2.d2l.ai/chapter_convolutional-modern/batch-norm.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[7.5. 批量规范化](https://zh-v2.d2l.ai/chapter_convolutional-modern/batch-norm.html)
> 项目：[动手学深度学习](https://github.com/d2l-ai/d2l-zh)
> 许可：[Apache-2.0](https://github.com/d2l-ai/d2l-zh/blob/master/LICENSE)

训练深层神经网络是十分困难的，特别是在较短的时间内使他们收敛更加棘手。 本节将介绍 *批量规范化* （batch normalization） ([Ioffe and Szegedy, 2015](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id75 "Ioffe, S., & Szegedy, C. (2015). Batch normalization: accelerating deep network training by reducing internal covariate shift. arXiv preprint arXiv:1502.03167."))，这是一种流行且有效的技术，可持续加速深层网络的收敛速度。 再结合在 [7.6节](https://zh-v2.d2l.ai/chapter_convolutional-modern/resnet.html#sec-resnet) 中将介绍的残差块，批量规范化使得研究人员能够训练100层以上的网络。

## 7.5.1. 训练深层网络

为什么需要批量规范化层呢？让我们来回顾一下训练神经网络时出现的一些实际挑战。

首先，数据预处理的方式通常会对最终结果产生巨大影响。 回想一下我们应用多层感知机来预测房价的例子（ [4.10节](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/kaggle-house-price.html#sec-kaggle-house) ）。 使用真实数据时，我们的第一步是标准化输入特征，使其平均值为0，方差为1。 直观地说，这种标准化可以很好地与我们的优化器配合使用，因为它可以将参数的量级进行统一。
...
从形式上来看，我们计算出 中的 $\hat{\boldsymbol{\mu}}_\mathcal{B}$ 和 ${\hat{\boldsymbol{\sigma}}_\mathcal{B}}$ ，如下所示：

(7.5.2) [¶](#equation-chapter-convolutional-modern-batch-norm-0 "Permalink to this equation") $\begin{split}\begin{aligned} \hat{\boldsymbol{\mu}}_\mathcal{B} &= \frac{1}{|\mathcal{B}|} \sum_{\mathbf{x} \in \mathcal{B}} \mathbf{x},\\
...
事实证明，这是深度学习中一个反复出现的主题。 由于尚未在理论上明确的原因，优化中的各种噪声源通常会导致更快的训练和较少的过拟合：这种变化似乎是正则化的一种形式。 在一些初步研究中， ([Teye *et al.*, 2018](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id167 "Teye, M., Azizpour, H., & Smith, K. (2018). Bayesian uncertainty estimation for batch normalized deep networks. arXiv preprint arXiv:1802.06455."))和 ([Luo *et al.*, 2018](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id103 "Luo, P., Wang, X., Shao, W., & Peng, Z. (2018). Towards understanding regularization in batch normalization. arXiv preprint."))分别将批量规范化的性质与贝叶斯先验相关联。 这些理论揭示了为什么批量规范化最适应 $50 \sim 100$ 范围中的中等批量大小的难题。
...
和以前一样，我们将在Fashion-MNIST数据集上训练网络。 这个代码与我们第一次训练LeNet（ [6.6节](https://zh-v2.d2l.ai/chapter_convolutional-neural-networks/lenet.html#sec-lenet) ）时几乎完全相同，主要区别在于学习率大得多。
...
![../_images/output_batch-norm_cf033c_48_1.svg](https://zh-v2.d2l.ai/_images/output_batch-norm_cf033c_48_1.svg)
...
![../_images/output_batch-norm_cf033c_51_1.svg](https://zh-v2.d2l.ai/_images/output_batch-norm_cf033c_51_1.svg)
...
![../_images/output_batch-norm_cf033c_54_1.svg](https://zh-v2.d2l.ai/_images/output_batch-norm_cf033c_54_1.svg)
...
![../_images/output_batch-norm_cf033c_57_1.svg](https://zh-v2.d2l.ai/_images/output_batch-norm_cf033c_57_1.svg)
...
![../_images/output_batch-norm_cf033c_93_1.svg](https://zh-v2.d2l.ai/_images/output_batch-norm_cf033c_93_1.svg)
...
![../_images/output_batch-norm_cf033c_96_1.svg](https://zh-v2.d2l.ai/_images/output_batch-norm_cf033c_96_1.svg)
...
![../_images/output_batch-norm_cf033c_99_2.svg](https://zh-v2.d2l.ai/_images/output_batch-norm_cf033c_99_2.svg)
...
![../_images/output_batch-norm_cf033c_102_1.svg](https://zh-v2.d2l.ai/_images/output_batch-norm_cf033c_102_1.svg)
