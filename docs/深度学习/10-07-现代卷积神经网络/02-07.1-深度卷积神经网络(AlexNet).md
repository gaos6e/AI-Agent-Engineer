...
source: "https://zh-v2.d2l.ai/chapter_convolutional-modern/alexnet.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[7.1. 深度卷积神经网络（AlexNet）](https://zh-v2.d2l.ai/chapter_convolutional-modern/alexnet.html)
...
3. 通过标准的特征提取算法，如SIFT（尺度不变特征变换） ([Lowe, 2004](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id102 "Lowe, D. G. (2004). Distinctive image features from scale-invariant keypoints. International journal of computer vision, 60(2), 91–110."))和SURF（加速鲁棒特征） ([Bay *et al.*, 2006](https://zh-v2.d2l.ai/chapter_references/zreferences.html#id7 "Bay, H., Tuytelaars, T., & Van Gool, L. (2006). Surf: speeded up robust features. European conference on computer vision (pp. 404–417)."))或其他手动调整的流水线来输入数据。
...
AlexNet和LeNet的架构非常相似，如 所示。 注意，本书在这里提供的是一个稍微精简版本的AlexNet，去除了当年需要两个小型GPU同时运算的设计特点。
...
AlexNet通过暂退法（ [4.6节](https://zh-v2.d2l.ai/chapter_multilayer-perceptrons/dropout.html#sec-dropout) ）控制全连接层的模型复杂度，而LeNet只使用了权重衰减。 为了进一步扩充数据，AlexNet在训练时增加了大量的图像增强数据，如翻转、裁切和变色。 这使得模型更健壮，更大的样本量有效地减少了过拟合。 在 [13.1节](https://zh-v2.d2l.ai/chapter_computer-vision/image-augmentation.html#sec-image-augmentation) 中更详细地讨论数据扩增。
...
我们构造一个高度和宽度都为224的单通道数据，来观察每一层输出的形状。 它与 中的AlexNet架构相匹配。
...
现在AlexNet可以开始被训练了。与 [6.6节](https://zh-v2.d2l.ai/chapter_convolutional-neural-networks/lenet.html#sec-lenet) 中的LeNet相比，这里的主要变化是使用更小的学习速率训练，这是因为网络更深更广、图像分辨率更高，训练卷积神经网络就更昂贵。
...
![../_images/output_alexnet_180871_35_1.svg](https://zh-v2.d2l.ai/_images/output_alexnet_180871_35_1.svg)
...
![../_images/output_alexnet_180871_38_1.svg](https://zh-v2.d2l.ai/_images/output_alexnet_180871_38_1.svg)
...
![../_images/output_alexnet_180871_41_2.svg](https://zh-v2.d2l.ai/_images/output_alexnet_180871_41_2.svg)
...
![../_images/output_alexnet_180871_44_1.svg](https://zh-v2.d2l.ai/_images/output_alexnet_180871_44_1.svg)
