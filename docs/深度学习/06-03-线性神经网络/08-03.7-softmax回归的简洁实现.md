...
source: "https://zh-v2.d2l.ai/chapter_linear-networks/softmax-regression-concise.html"
created: 2026-05-07
tags:
  - d2l
  - deep-learning
...
> [!info] 来源
> 原文：[3.7. softmax回归的简洁实现](https://zh-v2.d2l.ai/chapter_linear-networks/softmax-regression-concise.html)
> 项目：[动手学深度学习](https://github.com/d2l-ai/d2l-zh)
> 许可：[Apache-2.0](https://github.com/d2l-ai/d2l-zh/blob/master/LICENSE)

在 [3.3节](https://zh-v2.d2l.ai/chapter_linear-networks/linear-regression-concise.html#sec-linear-concise) 中， 我们发现通过深度学习框架的高级API能够使实现

线性回归变得更加容易。 同样，通过深度学习框架的高级API也能更方便地实现softmax回归模型。 本节如在 [3.6节](https://zh-v2.d2l.ai/chapter_linear-networks/softmax-regression-scratch.html#sec-softmax-scratch) 中一样， 继续使用Fashion-MNIST数据集，并保持批量大小为256。
...
如我们在 [3.4节](https://zh-v2.d2l.ai/chapter_linear-networks/softmax-regression.html#sec-softmax) 所述， softmax回归的输出层是一个全连接层。 因此，为了实现我们的模型， 我们只需在 `Sequential` 中添加一个带有10个输出的全连接层。 同样，在这里 `Sequential` 并不是必要的， 但它是实现深度模型的基础。 我们仍然以均值0和标准差0.01随机初始化权重。
...
在前面 [3.6节](https://zh-v2.d2l.ai/chapter_linear-networks/softmax-regression-scratch.html#sec-softmax-scratch) 的例子中， 我们计算了模型的输出，然后将此输出送入交叉熵损失。 从数学上讲，这是一件完全合理的事情。 然而，从计算角度来看，指数可能会造成数值稳定性问题。
...
(3.7.1) [¶](#equation-chapter-linear-networks-softmax-regression-concise-0 "Permalink to this equation") $\begin{split}\begin{aligned}
...
(3.7.2) [¶](#equation-chapter-linear-networks-softmax-regression-concise-1 "Permalink to this equation") $\begin{split}\begin{aligned}
...
接下来我们调用 [3.6节](https://zh-v2.d2l.ai/chapter_linear-networks/softmax-regression-scratch.html#sec-softmax-scratch) 中 定义的训练函数来训练模型。
...
![../_images/output_softmax-regression-concise_75d138_63_0.svg](https://zh-v2.d2l.ai/_images/output_softmax-regression-concise_75d138_63_0.svg)
...
![../_images/output_softmax-regression-concise_75d138_69_0.svg](https://zh-v2.d2l.ai/_images/output_softmax-regression-concise_75d138_69_0.svg)
...
![../_images/output_softmax-regression-concise_75d138_72_0.svg](https://zh-v2.d2l.ai/_images/output_softmax-regression-concise_75d138_72_0.svg)
