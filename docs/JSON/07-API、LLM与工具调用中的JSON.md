...
截至 2026-07-14，OpenAI 官方文档仍明确区分 JSON mode 与 Structured Outputs；Anthropic 官方文档也提供基于受支持 JSON Schema 子集的 strict tool use。具体字段、模型兼容性和支持关键字属于动态事实，实施时必须重新查目标厂商文档。
