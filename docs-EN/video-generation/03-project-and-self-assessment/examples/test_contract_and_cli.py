...
class TopAndTechnicalContractTests(unittest.TestCase):
    ...
    def test_missing_top_field(self) -> None:
        ...
        del package["purpose"]
        self.assert_invalid(package, "missing required fields")

    def test_unknown_top_field(self) -> None:
        package = valid_package()
        package["provider_request"] = {}
        self.assert_invalid(package, "unknown fields")
    ...
    def test_duration_rejects_nonfinite_direct_value(self) -> None:
        ...
        self.assert_invalid(package, "finite positive number")
...
class ShotAndAssetContractTests(unittest.TestCase):
    ...
    def test_anchors_must_be_nonempty(self) -> None:
        ...
        self.assert_invalid(package, "non-empty list")

    def test_anchor_items_must_be_strings(self) -> None:
        package = valid_package()
        package["shots"][0]["continuity_anchors"] = [1]
        self.assert_invalid(package, "non-empty string")

    def test_anchors_reject_duplicates(self) -> None:
        package = valid_package()
        package["shots"][0]["continuity_anchors"] = ["consistent lighting", "consistent lighting"]
        self.assert_invalid(package, "duplicate items")
    ...
    def test_asset_hash_must_be_lowercase_sha256(self) -> None:
        ...
        package["shots"][0]["reference_assets"] = [asset]
        self.assert_invalid(package, "64 lowercase")
    ...
    def test_asset_ids_must_be_globally_unique(self) -> None:
        ...
        self.assert_invalid(package, "Duplicate reference asset_id")
...
class AuditTests(unittest.TestCase):
    ...
    def test_validate_package_compatibility_helper(self) -> None:
        ...
        self.assertIn("Input contract error", validate_package([])[0])
    ...
    def test_overlapping_captions(self) -> None:
        ...
        self.assertIn("overlaps the previous caption", " ".join(audit_package(package)))
    ...
    def test_real_person_requires_consent_record(self) -> None:
        ...
        self.assertIn("consent record", " ".join(audit_package(package)))
    ...
    def test_object_acl_is_a_hard_gate_before_scoring(self) -> None:
        ...
        self.assertIn("object-level authorization/ACL", " ".join(audit_package(package)))
    ...
    def test_duplicate_acceptance_dimension(self) -> None:
        ...
        self.assertIn("Duplicate", " ".join(audit_package(package)))
    ...
    def test_secret_like_value_is_rejected(self) -> None:
        ...
        self.assertIn("secret", " ".join(audit_package(package)))
