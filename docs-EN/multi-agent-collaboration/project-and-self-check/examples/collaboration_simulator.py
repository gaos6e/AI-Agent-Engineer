...
TASK_STATES = {"pending", "running"} | TERMINAL_TASK_STATES
...
class CollaborationSimulator:
    ...
    def accept_result(
        ...
        digest = self._result_digest(payload)
        ...
        self.accepted_result_digests[result_key] = digest
        self._accepted_result_payloads[result_key] = deepcopy(payload)
